...
\begin{figure*}
\includegraphics[angle=0,width=7.0in]{ms_arms_number_weighted_contour.pdf}
...
\begin{figure*}
\includegraphics[angle=0,width=7.0in]{ms_arms_winding_weighted.pdf}
...
\begin{figure*}
\includegraphics[angle=0,width=7.0in]{ms_bar_contour.pdf}
...
\begin{figure}
\includegraphics[angle=0,width=3.5in]{sigma_mstar.pdf}
...
\begin{figure*}
\includegraphics[angle=0,width=7.0in]{ms_mergers_both.pdf}
